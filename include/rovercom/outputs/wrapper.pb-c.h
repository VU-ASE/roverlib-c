...
typedef enum
{
  ...
  PROTOBUF_MSGS__SENSOR_OUTPUT__SENSOR_OUTPUT_ENERGY_OUTPUT = 22 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(PROTOBUF_MSGS__SENSOR_OUTPUT__SENSOR_OUTPUT)
...
#define PROTOBUF_MSGS__SENSOR_OUTPUT__INIT \
  {PROTOBUF_C_MESSAGE_INIT(&protobuf_msgs__sensor_output__descriptor), 0, 0, 0, PROTOBUF_MSGS__SENSOR_OUTPUT__SENSOR_OUTPUT__NOT_SET, {0}}

/* ProtobufMsgs__SensorOutput methods */
void protobuf_msgs__sensor_output__init(ProtobufMsgs__SensorOutput *message);
size_t protobuf_msgs__sensor_output__get_packed_size(const ProtobufMsgs__SensorOutput *message);
size_t protobuf_msgs__sensor_output__pack(const ProtobufMsgs__SensorOutput *message,
                                          uint8_t *out);
size_t protobuf_msgs__sensor_output__pack_to_buffer(const ProtobufMsgs__SensorOutput *message,
                                                    ProtobufCBuffer *buffer);
ProtobufMsgs__SensorOutput *
protobuf_msgs__sensor_output__unpack(ProtobufCAllocator *allocator,
                                     size_t len,
                                     const uint8_t *data);
void protobuf_msgs__sensor_output__free_unpacked(ProtobufMsgs__SensorOutput *message,
                                                 ProtobufCAllocator *allocator);
/* --- per-message closures --- */

typedef void (*ProtobufMsgs__SensorOutput_Closure)(const ProtobufMsgs__SensorOutput *message,
                                                   void *closure_data);
